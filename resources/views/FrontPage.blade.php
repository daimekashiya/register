        ...
        <div id="rev-slider" class="rev-slider"  data-version="5.0">
          ...
          <ul>
            ...
            <li data-transition="fade" class="align-right">
              ...
              <img src="{{asset('img/1920x600_slide1.jpg')}}" class="rev-slidebg" alt="">
              ...
              <div class="tp-caption tp-resizeme scaption-white-medium rs-parallaxlevel-1"
                ...
                data-elementdelay="0.05" >Accelerate</div>
              ...
              <div class="tp-caption tp-resizeme scaption-white-large rs-parallaxlevel-3"
                ...
                data-responsive_offset="on" 
                data-elementdelay="0.05" >Air Cargo!</div>
            ...
            <li data-transition="fade" class="align-left">
              ...
              <img src="{{asset('img/1920x600_slide2.jpg')}}" class="rev-slidebg" alt="">
            ...
            <li data-transition="fade" class="align-right">
              ...
              <img src="{{asset('img/1920x600_slide3.jpg')}}" class="rev-slidebg" alt="">
...
<!--   
      ...
      <!-- </div> -->
        ...
        <!-- page-section -->
        <div class="page-section parallax-section" data-bg="{{asset('img/2433x1637_bg.jpg')}}">
                ...
                <div class="item-carousel">
                  ...
                  <div class="testimonial">
                    ...
                    <div class="author-box">
                      ...
                      <a href="#" class="avatar">
                        <img src="{{asset('img/120x120_avatar1.png')}}" alt="">
                      </a>
                ...
                <div class="item-carousel">
                  ...
                  <div class="testimonial">
                    ...
                    <div class="author-box">
                      ...
                      <a href="#" class="avatar">
                        <img src="{{asset('img/120x120_avatar2.png')}}" alt="">
                      </a>
          ...
          <div class="container">
            ...
            <div class="carousel-type-2">
              ...
              <div class="owl-carousel brend-box" data-max-items="6" data-item-margin="30" data-autoplay="true">
                ...
                <div class="item-carousel">
                  <!-- Carousel Item -->
                  <a href="#"><img src="{{asset('img/brend1.jpg')}}" alt=""></a>
                  <!-- /Carousel Item -->
                </div>
                <!-- /Slide -->
                ...
                <div class="item-carousel">
                  <!-- Carousel Item -->
                  <a href="#"><img src="{{asset('img/brend2.jpg')}}" alt=""></a>
                  <!-- /Carousel Item -->
                </div>
                <!-- /Slide -->
                ...
                <div class="item-carousel">
                  <!-- Carousel Item -->
                  <a href="#"><img src="{{asset('img/brend3.jpg')}}" alt=""></a>
                  <!-- /Carousel Item -->
                </div>
                <!-- /Slide -->
                ...
                <div class="item-carousel">
                  <!-- Carousel Item -->
                  <a href="#"><img src="{{asset('img/brend4.jpg')}}" alt=""></a>
                  <!-- /Carousel Item -->
                </div>
                <!-- /Slide -->
                ...
                <div class="item-carousel">
                  <!-- Carousel Item -->
                  <a href="#"><img src="{{asset('img/brend5.jpg')}}" alt=""></a>
                  <!-- /Carousel Item -->
                </div>
                <!-- /Slide -->
              ...
              <div class="owl-carousel entry-box" data-max-items="3" data-item-margin="30" >
                ...
                <div class="item-carousel">
                  ...
                  <div class="entry-attachment">
                    ...
                    <div class="thumbnail-attachment">
                      <img src="{{asset('img/360x260_img1.jpg')}}" alt="">
                    </div>
                ...
                <div class="item-carousel">
                  ...
                  <div class="entry-attachment">
                    ...
                    <div class="thumbnail-attachment">
                      <img src="{{asset('img/360x260_img2.jpg')}}" alt="">
                    </div>
                ...
                <div class="item-carousel">
                  ...
                  <div class="entry-attachment">
                    ...
                    <div class="thumbnail-attachment">
                      <img src="{{asset('img/360x260_img3.jpg')}}" alt="">
                    </div>
              ...
              <div class="col-md-3">
                ...
                <div class="align-right">
                  <div class="button-holder">
                    <a href="#" class="btn btn-big">Search Now</a>
                    <p>Or Call <span>+603 7845 5233</span></p>
                  </div>
                </div>
